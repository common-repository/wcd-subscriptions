...
if ( ! class_exists( 'Wcd_Subscriptions_Expire_Email' ) ) {
	 ...
	 * @subpackage Subscriptions_For_Woocommerce/email
	 */
	class Wcd_Subscriptions_Expire_Email extends WC_Email {
		/**
		...
		public function __construct() {
			...
			$this->id          = 'wcd_subscription_expire';
			$this->title       = __( 'Email Notification When Subscription Expired', 'wcd-subscriptions' );
			$this->description = __( 'If any subscription is Expired then this Email Notification Send', 'wcd-subscriptions' );
			$this->template_html  = 'wcd_subscription_expire-email-template.php';
			$this->template_plain = 'plain/wcd_subscription_expire-email-template.php';
		...
		public function get_default_subject() {
			return __( 'Expired Susbcription Email {site_title}', 'wcd-subscriptions' );
		}
		...
		public function get_default_heading() {
			return __( 'Subscription Expired', 'wcd-subscriptions' );
		}
...
return new Wcd_Subscriptions_Expire_Email();
